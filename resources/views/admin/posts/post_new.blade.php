...
@section('title', 'Thống kê bài viết mới trong ngày')



@section('content_header')

    <h1>Thống kê bài viết mới đăng tải trong ngày</h1>
...
@section('content')
 <div class="box">
        <div class="box-header with-border">
            <span>Tổng số bài viết mới được đăng tải trong ngày </span><span class="badge badge-info">{{count($posts)}}</span>
        </div>
    <div class="box-body">
