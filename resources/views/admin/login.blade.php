...
<html lang="en">
<head>
        <title>QBlog | Đăng nhập hệ thống Admin</title>
    <meta charset="UTF-8">
...
<div class="limiter">
    <div class="container-login100">
        <div class="wrap-login100">
            <div class="login100-form-title" style="background-image: url({{asset('backend/images/bg-01.jpg')}});">
                    <span class="login100-form-title-1">
                        Sign In To Admin
                    </span>
            </div>

            <form class="login100-form validate-form" action="{{URL::route('admin.login')}}" method="post">
