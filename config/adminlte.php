...
return [
    ...
    */
    ...
    'dashboard_url' => 'admin/posts/post_list',
    ...
    */
    ...
    'menu' => [
        ...
        [
            ...
            'url'         => 'admin/posts/post_list',
            'icon'        => 'far fa-fw fa-list-alt',
            'label'       => '',
            'label_color' => 'success',
        ],
        [
            'text'        => 'THỐNG KÊ BÀI MỚI',
            'url'         => 'admin/posts/post_new',
        ...
        [
            ...
            'submenu'   =>  [
               [
                   ...
                   'url'   =>  '/admin/admin_account/index'
               ],

               [
                   'text' => 'Thêm admin',
                   'icon' => 'fas fa-fw fa-user-plus',
                   'url' => '/admin/admin_account/add'
               ],
           ]
       ],
       [
           ...
           'submenu'   =>  [
               [
                   ...
                   'url'   =>  '/admin/user_account/index'
               ],
               [
                   'text' => 'Thống kê user đăng ký',
                   'icon' => 'fas fa-fw fa-user-tag',
                   'url' => '/admin/user_account/user_new'
               ],
               [
                   'text' => 'Thống kê user hoạt động',
                   'icon' => 'fas fa-fw fa-skiing-nordic',
                   'url' => '/admin/user_account/user_active'
               ],
           ]
       ],
        // [
